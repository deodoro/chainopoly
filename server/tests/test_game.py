...
def test_move_events(game):
    ...
    assert check_event({"event": "action", "type": "offer", "from.account": "1", "property.id": 4})
...
def test_a_few_rounds(game):
    ...
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 8})
    game.money.transfer("2", game.properties.account, 160)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 13})
    game.money.transfer("2", game.properties.account, 220)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 17})
    game.money.transfer("2", game.properties.account, 280)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "1", "property.id": 21})
    game.money.transfer("1", game.properties.account, 350)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 1})
    game.money.transfer("2", game.properties.account, 60)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "1", "property.id": 10})
    game.money.transfer("1", game.properties.account, 180)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "1", "property.id": 14})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 5})
    ...
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "1", "property.id": 16})
    game.money.transfer("1", game.properties.account, 260)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "offer", "from.account": "2", "property.id": 20})
    game.money.transfer("2", game.properties.account, 320)
    assert check_event({"event": "transaction"})
    assert check_event({"event": "match"})
    assert check_event({"event": "newround"})
    assert check_event({"event": "action", "type": "rent", "from.account": "2", "property.id": 21})
